...
plt.plot(time_gm2, good_afternoon, label='Good afternoon', alpha=0.5)
plt.plot(time_gm3, plane, label='Plane', alpha=0.5)
plt.plot(time_gm4, anymore, label='Anymore', alpha=0.5)
